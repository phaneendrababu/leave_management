...
?>
  ...
  <div class="column right">
    ...
    <div style="width:100%;height:80%;background-color:white;border-radius:5px; box-shadow:5px 5px 5px;">
        
    <div class="mui-container">
        <div class="mui-panel" style="font-weight:bold;color:#03a9f4">
...
if(isset($_POST['submit']))
{
    ...
    $sql1="INSERT INTO `faculty`(`id`, `perid`, `fullname`, `email`, `password`, `gender`, `department`, `mobileno`) VALUES ('$count+1','$perid','$fullname','$emailid','$password','$gender','$department','$mobileno')";
    
    $run1=mysqli_query($sql1);
    
    if($run1==TRUE)
    {
        echo"<script>alert('New faculty details added successfully')</script>";
    }
}
?>