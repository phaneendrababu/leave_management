...
?>
  ...
  <div class="column right" style="overflow-y: scroll;">
    ...
    <div class="mui-panel" style="font-weight:bold;color:#03a9f4;margin-bottom:0px;">
    <div class="mui-row">
        <div class="mui-col-md-4">
             <a href="show_all_list.php" style="color:#03a9f4">GO BACK</a>
        </div>
        <div class="mui-col-md-4">
...
<thead><tr><th>FACULTY</th><th>PERIOD TIMINGS</th><th>SECTION</th></tr>
</thead>
  <tbody>
     <?php
    include 'conn.php';
        ...
        {
            $stamp=$_POST['stamp'];
            $sql="SELECT * FROM leave_apply where timestamp='$stamp'";
            $run=mysqli_query($conn,$sql);
            //var_dump($sql);
            //var_dump($run);
